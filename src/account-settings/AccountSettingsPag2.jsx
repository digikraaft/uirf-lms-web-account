...
//   return (
//     <div className="w-full xl:w-auto xl:min-w-[calc(100%-256px)] xl:ml-[256px] h-auto xl:min-h-screen">
//       {/* Fixed Top Bar */}
//       <div>
...
//               Korede's Dashboard - Let's jump back in.
//             </h1>
//           </div>
...
//         <div
//           className={`w-full absolute top-10 bg-y text-white z-50 transition-transform ease-in duration-500 ${
...
//               <a
//                 href="dashboard.html"
//                 className="block py-2 px-3 text-white bg-cFF0 rounded-sm"
//               >
//                 Dashboard
//               </a>
//             </li>
...
//           <h1 className="xl:text-3xl font-semibold text-xl lg:text-2xl text-black">
//             Account Information
//           </h1>
//         </div>
//         <div className="mt-7">
...
//                     <div>
//                       <div className="w-full flex flex-col md:flex-row space-x-0 md:space-x-3 md:justify-between space-y-6 md:space-y-0">
...
//                             className="w-full outline-none border border-dark-grey focus:border-cFF0 focus:ring-1 focus:ring-cFF0 px-2 py-2 rounded peer focus:placeholder-transparent"
//                           />
//                           <label
//                             htmlFor="firstname"
//                             className="absolute left-3 px-2 top-2 duration-200 text-dark-grey text-dark-grey transition-all hidden peer-focus:block peer-focus:bg-white peer-placeholder-shown:text-sm peer-focus:-top-3"
//                           >
//                             First name
//                           </label>
//                         </div>
...
//                           The name that is used for ID verification and
//                           that appears on your certificates.
//                         </p>
//                       </div>
//                     </div>
...
//                         {/* <PasswordField /> */}
//                       </div>
//                       <div className="w-full flex flex-col space-y-6 xl:space-y-0 xl:flex-row xl:items-center space-x-6">
...
//                             <option value="ng">English</option>
//                             <option value="gh">French</option>
//                           </select>
//                           <label
//                             htmlFor="language"
//                             className="absolute left-3 px-2 top-2 duration-200 text-dark-grey text-dark-grey transition-all hidden peer-focus:block peer-focus:bg-white peer-placeholder-shown:text-sm peer-focus:-top-3"
...
//                               The name that is used for ID verification
//                               and that appears on your certificates.
//                             </p>
//                           </div>
//                         </div>
//                         <div className="relative w-full xl:w-1/2">
...
//                             <img src="../asset/info.svg" alt="" />
//                             <p className="text-xs text-dim">
//                               Select the time zone for displaying course
//                               dates. If you do not specify a time zone,
//                               course dates, including assignment
//                               deadlines, will be displayed in your
...
//               </form>
//               <div className="mt-6">
//                 <h1 className="text-lg xl:text-2xl font-semibold text-black mb-4">
//                   Delete My Account
//                 </h1>
//                 <div className="space-y-3 text-sm xl:text-base text-black">
//                   <p>We're sorry to see you go!</p>
//                   <p>
//                     Please note: Deletion of your account and personal
//                     data is permanent and cannot be undone. Tutorial will
//                     not be able to recover your account or the data that
//                     is deleted. Once your account is deleted, you cannot
//                     use it to take courses on Tutorial.
//                   </p>
//                   <p>
//                     You may also lose access to verified certificates and
//                     other program credentials. You can make a copy of
//                     these for your records before proceeding with
//                     deletion.
//                   </p>
//                   <p>
//                     Warning: Account deletion is permanent. Please read
//                     the above carefully before proceeding. This is an
//                     irreversible action, and you will no longer be able to
//                     use the same email on Tutorial.
//                   </p>
//                 </div>
//                 <div className="mt-4">
//                   <div>
//                     <a
//                       href="profile.html"
//                       className="text-cFF0 underline text-base font-medium mt-3"
//                     >
//                       Do you want to change your email, username or
//                       password instead?
//                     </a>
//                   </div>
//                   <div className="mt-4">
//                     <button className="px-6 py-2 bg-cFF0 text-white rounded">
//                       Delete my account
//                     </button>
//                   </div>
//                 </div>
